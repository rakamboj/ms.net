...
namespace SmartHotel.Registration
{
    public partial class Checkin : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var client = new Service().GetCheckin(registrationId);
            CustomerName.Value = client.CustomerName;
            Passport.Value = client.Passport;
            CustomerId.Value = client.CustomerId;
            Address.Value = client.Address;
            Amount.Value = client.Amount.ToString();
        }
    }
}